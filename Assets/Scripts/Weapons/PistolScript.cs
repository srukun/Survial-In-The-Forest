...
public class PistolScript : MonoBehaviour
{
    ...
    public void Shoot()
    {
        if (shootTimer <= 0 && Input.GetMouseButton(0))
        {
            ...
            arrow.transform.eulerAngles = new Vector3(0, 0, aimAngle - 90);
            arrow.GetComponent<Rigidbody2D>().AddForce(firePoint.right * DataManager.equipedWeapon.speed, ForceMode2D.Impulse);
