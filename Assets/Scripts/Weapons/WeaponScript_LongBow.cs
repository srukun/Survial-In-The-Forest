...
public class WeaponScript_LongBow : MonoBehaviour
{
    ...
    public void Shoot()
    {
        ...
        {
            GameObject SceneObject_Arrow = Instantiate(Prefab_Arrow, firePoint.position, Quaternion.Euler(0, 0, aimAngle - 10));
            GameObject SceneObject_Arrow2 = Instantiate(Prefab_Arrow, firePoint.position, Quaternion.Euler(0, 0, aimAngle + 10));
            ...
            SceneObject_Arrow2.GetComponent<Rigidbody2D>().AddForce(SceneObject_Arrow2.transform.right * DataManager.equipedWeapon.speed, ForceMode2D.Impulse);
